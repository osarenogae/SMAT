...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Severity Level</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link RiskMatrixModel.impl.SeverityLevelImpl#getLevelIndex <em>Level Index</em>}</li>
 *   <li>{@link RiskMatrixModel.impl.SeverityLevelImpl#getLevelName <em>Level Name</em>}</li>
 *   <li>{@link RiskMatrixModel.impl.SeverityLevelImpl#getRiskratinginstance <em>Riskratinginstance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SeverityLevelImpl extends MinimalEObjectImpl.Container implements SeverityLevel {
	/**
	...
	protected EClass eStaticClass() {
		return RiskMatrixModelPackage.Literals.SEVERITY_LEVEL;
	}
	...
	public void setLevelIndex(int newLevelIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RiskMatrixModelPackage.SEVERITY_LEVEL__LEVEL_INDEX, oldLevelIndex, levelIndex));
	}
	...
	public void setLevelName(String newLevelName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RiskMatrixModelPackage.SEVERITY_LEVEL__LEVEL_NAME, oldLevelName, levelName));
	}
	...
	public EList<RiskRatingInstance> getRiskratinginstance() {
		if (riskratinginstance == null) {
			riskratinginstance = new EObjectWithInverseResolvingEList<RiskRatingInstance>(RiskRatingInstance.class, this, RiskMatrixModelPackage.SEVERITY_LEVEL__RISKRATINGINSTANCE, RiskMatrixModelPackage.RISK_RATING_INSTANCE__SEVERITYLEVEL);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RiskMatrixModelPackage.SEVERITY_LEVEL__RISKRATINGINSTANCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RiskMatrixModelPackage.SEVERITY_LEVEL__LEVEL_INDEX:
				return getLevelIndex();
			case RiskMatrixModelPackage.SEVERITY_LEVEL__LEVEL_NAME:
				return getLevelName();
			case RiskMatrixModelPackage.SEVERITY_LEVEL__RISKRATINGINSTANCE:
