...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Control Type Eum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see careProcess_model.CareProcess_modelPackage#getControlTypeEum()
 * @model
 * @generated
 */
public enum ControlTypeEum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Control Type Eum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ControlTypeEum[] VALUES_ARRAY =
		new ControlTypeEum[] {
			DESIGN,
			TEST,
			TRAINING,
	...
	/**
	 * A public read-only list of all the '<em><b>Control Type Eum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ControlTypeEum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Control Type Eum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ControlTypeEum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ControlTypeEum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Control Type Eum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ControlTypeEum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ControlTypeEum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Control Type Eum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ControlTypeEum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ControlTypeEum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
