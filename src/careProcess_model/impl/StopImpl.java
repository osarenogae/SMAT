 ...
 * </p>
 * <ul>
 *   <li>{@link careProcess_model.impl.StopImpl#getSuccessors <em>Successors</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getStepTypeValue <em>Step Type Value</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getName <em>Name</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getHazardInstances <em>Hazard Instances</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getAssociatedSystemFunctions <em>Associated System Functions</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getUUID <em>UUID</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#getProcessGraph <em>Process Graph</em>}</li>
 *   <li>{@link careProcess_model.impl.StopImpl#isHidden <em>Hidden</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StopImpl extends MinimalEObjectImpl.Container implements Stop {
	 ...
	 * @ordered
	 */
	protected static final stepType STEP_TYPE_VALUE_EDEFAULT = stepType.STOP;
	...
	protected EClass eStaticClass() {
		return CareProcess_modelPackage.Literals.STOP;
	}
	...
	public EList<Step> getSuccessors() {
		if (successors == null) {
			successors = new EObjectResolvingEList<Step>(Step.class, this, CareProcess_modelPackage.STOP__SUCCESSORS);
		}
		return successors;
	}
	...
	public void setStepTypeValue(stepType newStepTypeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__STEP_TYPE_VALUE, oldStepTypeValue, stepTypeValue));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<HazardInstance> getHazardInstances() {
		if (hazardInstances == null) {
			hazardInstances = new EObjectWithInverseResolvingEList<HazardInstance>(HazardInstance.class, this, CareProcess_modelPackage.STOP__HAZARD_INSTANCES, CareProcess_modelPackage.HAZARD_INSTANCE__STEP);
		}
	...
	public LocationDefinition getLocation() {
		if (location != null && location.eIsProxy()) {
			...
			if (location != oldLocation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CareProcess_modelPackage.STOP__LOCATION, oldLocation, location));
			}
		}
		return location;
	}
	...
	public NotificationChain basicSetLocation(LocationDefinition newLocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__LOCATION, oldLocation, newLocation);
	...
	public void setLocation(LocationDefinition newLocation) {
		if (newLocation != location) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__LOCATION, newLocation, newLocation));
	}
	...
	public EList<SystemFunction> getAssociatedSystemFunctions() {
		if (associatedSystemFunctions == null) {
			associatedSystemFunctions = new EObjectWithInverseResolvingEList.ManyInverse<SystemFunction>(SystemFunction.class, this, CareProcess_modelPackage.STOP__ASSOCIATED_SYSTEM_FUNCTIONS, CareProcess_modelPackage.SYSTEM_FUNCTION__ASSOCIATED_STEPS);
		}
	...
	public void setUUID(String newUUID) {
		...
		uuid = newUUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__UUID, oldUUID, uuid));
	}
	...
	public processGraph getProcessGraph() {
		if (eContainerFeatureID() != CareProcess_modelPackage.STOP__PROCESS_GRAPH) return null;
	...
	public NotificationChain basicSetProcessGraph(processGraph newProcessGraph, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newProcessGraph, CareProcess_modelPackage.STOP__PROCESS_GRAPH, msgs);
		return msgs;
	}
	...
	public void setProcessGraph(processGraph newProcessGraph) {
		if (newProcessGraph != eInternalContainer() || (eContainerFeatureID() != CareProcess_modelPackage.STOP__PROCESS_GRAPH && newProcessGraph != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__PROCESS_GRAPH, newProcessGraph, newProcessGraph));
	}
	...
	public void setHidden(boolean newHidden) {
		...
		hidden = newHidden;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CareProcess_modelPackage.STOP__HIDDEN, oldHidden, hidden));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CareProcess_modelPackage.STOP__SUCCESSORS:
				return getSuccessors();
			case CareProcess_modelPackage.STOP__STEP_TYPE_VALUE:
				return getStepTypeValue();
			case CareProcess_modelPackage.STOP__NAME:
				return getName();
			case CareProcess_modelPackage.STOP__DESCRIPTION:
			...
			case CareProcess_modelPackage.STOP__UUID:
				return getUUID();
			case CareProcess_modelPackage.STOP__PROCESS_GRAPH:
				return getProcessGraph();
			case CareProcess_modelPackage.STOP__HIDDEN:
				return isHidden();
		}
